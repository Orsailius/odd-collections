...
describe("hashlist add(4,red)",()=>
{
  ...
  test('get 4 has red', () => {
    expect(hashlist.get(4)?.find(x=>x == 'red') != null).toBe(true);
  });
});
...
describe("hashlist add(4,red), add(4,green)",()=>
{
  ...
  test('get 4 has red and green', () => {
    expect(hashlist.get(4)?.find(x=>x == 'red') != null &&
     hashlist.get(4)?.find(x=>x == 'green') != null).toBe(true);
  });
});
...
describe("hashlist add(4,red), add(4,green) add(5,red)",()=>
{
  ...
  test('get 5 has red', () => {
    expect(hashlist.get(5)?.find(x=>x == 'red') != null).toBe(true);
  });
});
